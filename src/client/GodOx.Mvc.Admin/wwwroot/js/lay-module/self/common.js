layui.define(['table', 'toastr'], function (exports) {
    ...
    var  tool = {
        ...
        BindParentCategory: function (value) {
            tool.ajax('shop/category/getAllParentcategory', {}, "application/json", "get", function (res) {
        ...
        BindParentColumn: function (value) {
            tool.ajax('cms/column/getAllParentColumn', {}, "application/json", "get", function (res) {
                if (res.statusCode == 200 && res.success == true) {
                    if (res.data !== null) {
                        var select = $("#parentId");
                        for (var i = 0; i < res.data.length; i++) {
        ...
        BindParentMenu: function (value) {
            tool.ajax('sys/menu/getAllParentMenu', {}, "application/json", "get", function (res) {
                if (res.statusCode == 200 && res.success == true) {
                    if (res.data !== null) {
                        var select = $("#parentId");
                        for (var i = 0; i < res.data.length; i++) {
