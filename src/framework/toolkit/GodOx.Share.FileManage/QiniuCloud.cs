...
{
    public class QiniuCloud : IUploadFile
    {
        ...
        /// <returns></returns>
        public List<string> List(string prefix = "case", string marker = "")
        {
            ...
            if (listRet.Code != 200)
            {
                throw new ArgumentNullException(listRet.Text);
            }
            return listRet.Result.CommonPrefixes;
        }
        ...
        public bool Delete(string filename)
        {
            ...
            if (result.Code != 200)
            {
                throw new ArgumentNullException(result.Text);
            }
        ...
        public string Upload(IFormFile file, string prefix)
        {
            ...
            //HttpResult result = um.UploadFile(localFile, saveKey, token);        
            return _qiNiuOssModel.ImgDomain + saveKey;
        }
        ...
        private string GetToken()
        {
            ...
            {
                throw new ArgumentNullException("七牛云图片token获取为空!");
            }
            return token;
        }
